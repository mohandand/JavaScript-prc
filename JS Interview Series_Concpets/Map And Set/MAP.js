...
This is one of the major differences between Map and regular JavaScript objects 
where the key can only be a string: */
...
//Even when you pass it a primitive or object, it internally converts the key into a string:
