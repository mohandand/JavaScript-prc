...
this inside arrow function always points to its parent function and no parent function meants points to Object
*/
...
function Person3(name1){
    this.name1 = name1;
    this.getName1 = () => {this.name1}
    this.getName2 = function(){
        console.log(this.name1)
    }
}

const p3 = new Person3("Mohan DAnd");
console.log("inside")
console.log(p3.getName1());